...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    try {
      ...
      console.log(error);
      alert('Houve um erro ao criar anúncio!');
    }
  }
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg overflow-hidden w-[480px] shadow-lg shadow-black/25">
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          ...
          <label className="mt-2 flex items-center gap-2 text-sm">
            <Checkbox.Root
              ...
              className="w-7 h-7 p-1 rounded bg-zinc-900 border-2 border-transparent focus:border-violet-500 focus:ring-violet-500 focus:outline-none"
            >
